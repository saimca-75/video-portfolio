        ...
        <div className="grid lg:grid-cols-2 gap-16 items-start">
          ...
          >
            ...
            <p className="text-lg text-muted-foreground mb-10 leading-relaxed max-w-md">
              Fill out the form with your project details, and I'll get back to
              you with a custom proposal and next steps within 24 hours.
            </p>

            <div className="space-y-6">
              <a
                href="mailto:bandarusalman@gmail.com"
                className="flex items-center gap-4 text-white hover:text-primary transition-colors p-4 rounded-2xl bg-white/5 border border-white/5 w-fit"
              >
                ...
                <div>
                  ...
                  <p className="font-semibold">bandarusalman@gmail.com</p>
                </div>
              </a>
              <a
              ...
              >
                ...
                <div>
                  ...
                  <p className="font-semibold">+91 9182812899</p>
                </div>
              </a>
            </div>
          </motion.div>
            ...
            <Form {...form}>
              ...
              >
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="bandarusalman9@gmail.com"
                            className="bg-white/5 border-white/10 focus-visible:ring-primary"
                            {...field}
                          />
                        </FormControl>
                ...
                <Button
                  ...
                  size="lg"
                  disabled={submitting}
                  className="w-full bg-primary hover:bg-primary/90 text-white font-bold h-14 rounded-xl text-lg mt-4 disabled:opacity-60"
